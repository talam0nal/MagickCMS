...
class PagesController extends BaseController
{
	...
	*/
	...
	public function verstaki()
	{
		$page = new Page;
		$page->title = "Слесарный стол верстак, верстак универсальный, верстак слесарный однотумбовый, верстак слесарный, верстак металлический. Купить верстак слесарный металлический выгодно можно в компании \"Вэлмет\". Верстак цена и верстак слесарный металлический цена ниже рыночной.";
		$page->page_description = "Выполненные с применением новейших технологий, слесарный стол верстак, верстак универсальный, верстак слесарный однотумбовый, верстак слесарный, верстак металлический уже давно стали оптимальным решением проблемы оптимизации рабочего процесса, направленного на повышение производительности труда и снижение общего уровня утомляемости персонала. Купить верстак слесарный металлический выгодно можно в компании \"Вэлмет\". Верстак цена и верстак слесарный металлический цена ниже рыночной.";
		return view('frontend.pages.verstaki', [
			'page' => $page
		]);		
	}
